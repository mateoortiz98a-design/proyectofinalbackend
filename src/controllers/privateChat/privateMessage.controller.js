...
class PrivateMessageController {
    ...
    async update(req, res, next) {
        try {
            ...
            getIO().to(`private_chat:${message.fk_private_chat_id}`).emit('updated_private_message', message)
    ...
    async delete(req, res, next) {
        try {
            ...
            getIO().to(`private_chat:${deletedMessage.fk_private_chat_id}`).emit('deleted_private_message', { message_id })
