...
class MessageService {
    ...
    async createMessage(chat_id, user_id, mensaje) {
        ...
        if (!member) throw new Error("No perteneces a este workspace.");

        return await messageRepository.create(chat_id, user_id, mensaje.trim());
    }
    ...
    async updateMessage(message_id, user_id, update_data) {
        ...
        return await messageRepository.updateById(message_id, update_data);
    }
    ...
    async deleteMessage(message_id, user_id) {
        ...
        return message // ✅ retornar para usar fk_chat_id en el controller
    }
}
