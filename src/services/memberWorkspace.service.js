...
class MemberWorkspaceService {
    ...
    async inviteUser(user_invited_for_id, user_invited_email, workspace_id, role) {
        ...
        const accept_url = `${ENVIRONMENT.URL_BACKEND}/api/workspace/${workspace_id}/invite/${MEMBER_INVITATION_STATUS.ACCEPTED}?invitation_token=${invitation_token}`;
        const reject_url = `${ENVIRONMENT.URL_BACKEND}/api/workspace/${workspace_id}/invite/${MEMBER_INVITATION_STATUS.REJECTED}?invitation_token=${invitation_token}`;
